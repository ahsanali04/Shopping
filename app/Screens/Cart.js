    ...
    <View style={{backgroundColor: '#e6e6e6', flex: 1}}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          style={[tailwind` z-10`, {marginTop: responsiveHeight(3)}]}>
      ...
      {!!!cart.length && (
        <View style={tailwind`mt-10 justify-center px-5 items-center`}>
          <Text style={tailwind`text-center text-gray-500`}>
            You have no items yet! click add to cart icon and order the
            products! 👶
          </Text>
        </View>
      )}
          ...
          <View key={item.id} style={{marginTop: responsiveHeight(1)}}>
            <View
              ...
              <Image
                ...
                style={[
                  {height: responsiveHeight(8), width: responsiveWidth(20)},
                ]}
                resizeMode="contain"
              />
              <View
